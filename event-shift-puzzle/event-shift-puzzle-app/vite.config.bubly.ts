  ...
  build: {
    ...
    rollupOptions: {
      ...
      external: (id) => {
        ...
        if (
          id === "@bublys-org/event-shift-puzzle-libs" ||
          id.startsWith("@bublys-org/event-shift-puzzle-libs/") ||
          id === "@bublys-org/event-shift-puzzle-model" ||
          id.startsWith("@bublys-org/event-shift-puzzle-model/")
        ) {
          return false;
        }
