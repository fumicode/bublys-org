...
import {
  type ShiftPlanState,
  ShiftPlan,
} from "@bublys-org/event-shift-puzzle-model";
import type { ShiftState } from "@bublys-org/event-shift-puzzle-model";

// Re-export TimeSchedule / BlockList for convenience
export { TimeSchedule, BlockList } from "@bublys-org/event-shift-puzzle-model";
