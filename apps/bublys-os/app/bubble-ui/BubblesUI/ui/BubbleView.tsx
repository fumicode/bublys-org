...
type BubbleProps = {
  ...
  onMagicWandAction?: MagicWandActionCallback; // MagicWandモードで実行するアクション
...
const BubbleViewInner: FC<BubbleProps> = ({
  ...
  const {
    ...
    bubbleId: bubble.id,
    onCloseClick: onCloseClick ? () => onCloseClick(bubble) : undefined,
    magicWandAction: onMagicWandAction,
  });
