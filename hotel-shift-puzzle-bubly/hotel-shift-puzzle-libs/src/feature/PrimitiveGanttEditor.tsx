 ...
 * - ブラシソース：別バブル（hotel-shift-puzzle/tasks の TaskList）からタスクをドラッグ
...
export const PrimitiveGanttEditor: FC<PrimitiveGanttEditorProps> = ({
  ...
  const members = useAppSelector(selectHotelShiftPuzzleMemberList);
  const shiftPlan = useAppSelector(selectHotelShiftPuzzlePlanById(shiftPlanId));
