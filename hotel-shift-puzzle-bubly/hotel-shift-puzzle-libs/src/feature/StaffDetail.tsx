...
import { Staff, ConstraintSet, ScheduleReport } from "@bublys-org/hotel-shift-puzzle-model";
import { StaffDetailView } from "../ui/StaffDetailView.js";
import { useObject, useObjects, useObjectRepo } from "../objects/repository.js";
import { STAFF_TYPE, CONSTRAINT_SET_TYPE, SCHEDULE_REPORT_TYPE } from "../objects/hotelObjects.js";
